...
my @Tests =
    (
     ...
     ['composite-dash-D', "-d '2024-06-15 07:08:09' +%-D", {OUT=>'06/15/24'}],
     ['composite-dash-F', "-d '2024-06-15 07:08:09' +%-F", {OUT=>'2024-06-15'}],
     ['composite-dash-T', "-d '2024-06-15 07:08:09' +%-T", {OUT=>'07:08:09'}],
     ['composite-dash-R', "-d '2024-06-15 07:08:09' +%-R", {OUT=>'07:08'}],
     ['composite-dash-r', "-d '2024-06-15 07:08:09' +%-r",
      {OUT=>'07:08:09 AM'}],
     ['composite-dash-x', "-d '2024-06-15 07:08:09' +%-x", {OUT=>'06/15/24'}],
     ['composite-dash-X', "-d '2024-06-15 07:08:09' +%-X", {OUT=>'07:08:09'}],
     # Other flags and the width still apply to the whole expansion.
     ['composite-underscore-D', "-d '2024-06-15' +%_D", {OUT=>'06/15/24'}],
     ['composite-zero-D', "-d '2024-06-15' +%0D", {OUT=>'06/15/24'}],
     ['composite-width-D', "-d '2024-06-15' +%10D", {OUT=>'  06/15/24'}],
     # For comparison, '-' does suppress padding for simple specifiers.
     ['dash-simple-m', "-d '2024-06-15' +%-m", {OUT=>'6'}],
     ['dash-simple-d', "-d '2024-06-05' +%-d", {OUT=>'5'}],
